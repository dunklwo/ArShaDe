...
int main(){
 encrypt e;
 encrypt2 e2;
 cout<<"Welcome to ArShaDe! The one stop destination to empower organizations and individuals with robust 
encryption technologies that uphold the highest standards of security and privacy. Our mission is to deliver 
innovative encryption solutions that enable secure data storage, transmission, and communication across diverse 
platforms and environments."<<endl;
 cout<<"we offer three levels of encryption:"<<endl;
 cout<<"1.Basic : Caesar cipher, a simple encryption technique that operates by shifting the letters of the 
alphabet by a fixed number of positions. The encryption process involves replacing each letter in the plaintext with 
another letter positioned a fixed distance away in the alphabet."<<endl;
 cout<<"Price : Rs.10,000"<<endl;
 cout<<"2.Intermediate : Caesar cipher combined with morse code which provides an added level of security to 
your data where the data is first encrypted using caesar cipher and then using morse code"<<endl;
 cout<<"Price : Rs.30,000"<<endl;
 cout<<"3.RSA, a widely-used encryption algorithm that relies on the mathematical complexity of factoring large 
numbers. It involves generating a public key for encryption and a private key for decryption. RSA is secure due to 
the difficulty of factoring large numbers into their prime components without the private key."<<endl;
